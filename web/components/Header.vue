        ...
        <section class="px-5 py-1 bg-gradient-to-r from-amber-400 to-amber-600 border-b border-amber-700">
            <div class="max-w-7xl mx-auto flex justify-between">
                ...
                <section class="flex flex-row items-center gap-4">
                    <NuxtLink to="https://nexa.exchange/markets" target="_blank" class="px-5 py-1 flex items-end text-gray-500 bg-amber-700 border-0 border-yellow-400 rounded-full hover:bg-amber-600">
                    ...
                    <div class="relative">
                        <input
                            ...
                            class="cursor-pointer h-10 px-5 py-1 text-amber-100 placeholder:text-amber-100 font-medium bg-gray-900 border-0 border-amber-300 rounded-full hover:bg-gray-800"
                            disabled
                        />

                        <div class="pointer-events-none absolute inset-y-0 right-0 flex py-2.5 pr-3.5">
                            <kbd class="inline-flex items-center rounded border border-gray-200 px-1.5 font-sans text-xs text-gray-400">/</kbd>
                        </div>
                    </div>

                    <svg class="cursor-not-allowed w-8 h-auto text-amber-200" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
